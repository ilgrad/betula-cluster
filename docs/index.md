...
with the compression size, not with `N` — so it labels **a million points in ~0.3 s** and streams
**ten million in a flat ~53 MB of RAM**, at quality on par with scikit-learn.
