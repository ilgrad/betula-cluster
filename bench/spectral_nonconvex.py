"""Non-convex benchmark: betula spectral / louvain vs scikit-learn SpectralClustering.
...
the cost; louvain (community detection) is included as an honest negative — it over-splits manifolds.
...
def main() -> None:
    ...
    methods = {
        ...
        "betula-louvain": lambda x: bc.fit_predict(x, 2, method="louvain", **BETULA_KW),
