...
**Done & verified** — 137 Rust unit + 4 integration tests (default features; the `python` / `cli`
surfaces add more) + a 167-case `pytest` suite (Python wrapper at 100 % line coverage, Rust ≥95 %
