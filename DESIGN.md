...
**Done & verified** — 202 Rust unit + 4 integration tests (default features; the `cli` binary adds
8 more, and 201 + 4 run with `--no-default-features`) + a 228-case `pytest` suite (Python wrapper at 100 % line coverage, Rust ≥95 %
